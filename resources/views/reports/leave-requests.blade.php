        ...
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white shadow rounded-xl p-6">
                <div class="flex flex-col gap-4">
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800">Leave Reports</h2>
                        <p class="text-sm text-gray-500 mt-1">
                            Detailed leave report with filters and export.
                        </p>
                    </div>

                    <form method="GET" action="{{ route('reports.leaves') }}" class="grid grid-cols-1 md:grid-cols-6 gap-4">
                        <div>
                        ...
                        <div class="flex items-end gap-2">
                            ...
                            <a href="{{ route('reports.leaves.export', request()->query()) }}"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-5">
                <div class="bg-white shadow rounded-xl p-5">
                    ...
                    <h4 class="text-3xl font-bold text-gray-800 mt-2">{{ $summary['total_requests'] }}</h4>
                </div>
                ...
                <div class="bg-white shadow rounded-xl p-5">
                    ...
                    <h4 class="text-3xl font-bold text-indigo-600 mt-2">{{ $summary['approved_days'] }}</h4>
                </div>
            </div>
